...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=10, init_weights=True):
        ...
        # 自己增加的
        # self.changechannel = conv1x1(1, 3)
...
def _vgg(arch, cfg, batch_norm, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls[arch], progress=progress))
...
def vgg16(pretrained, **kwargs):
    ...
    if pretrained:
        pre_model = models.vgg16(pretrained, progress=True)
        ...
        # for param in model.changechannel.parameters():
        #     param.requires_grad = True
...
#
#     model = models.vgg19(pretrained=pretrained, progress=True)
#
#     if pretrained == True:
#         for param in model.parameters():
#             param.requires_grad = False
...
#     model.classifier[6] = nn.Linear(num_fc_inputs, 10)
#
#     return model
...
def vgg19(pretrained, **kwargs):
    ...
    if pretrained:
        pre_model = models.vgg19(pretrained, progress=True)
