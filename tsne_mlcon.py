...
from utils.tsne_test import train_utils
...
if __name__ == '__main__':
    ...
    # sub_dir = '01-86'
    # pth_name = '0-1.0000-best_model.pth'

    # sub_dir = 'resnet18_CWRU_STFT_1001-001408'
    # # pth_name = '1-0.9904-best_model.pth'
    # pth_name = 'target fine-tune 0.9609-last_model.pth'

    # sub_dir = 'resnet18_CWRU_STFT_1001-011356'
    # pth_name = '0-1.0000-best_model.pth'
    # pth_name = 'target fine-tune 0.9609-last_model.pth'
    ...
    trainer.train()
    # trainer.transfer_condition(savemodelpath=pth_name)
